    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top  " style="background-color:  #0066cc">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <li class="nav-item active">
         ...
         <li class="nav-item ">
            <a class="nav-link" href="#">Gerenciar Chamados  <span class="sr-only">(current)</span></a>
          </li>
          <?php } ?>
        ...
        <?php if($_SESSION['login'] ==true){?>
          ...
          <a class="btn btn-outline-success my-2 my-sm-0" href="/cadastro/editar_cadastro">Perfil</a>
